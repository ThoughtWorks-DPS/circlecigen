...
@click.option("--workflow", default="continuation-generated-workflow",
                help="Name for generated config. Default is continuation-generated-workflow",
                callback=validate_filename_arg)
...
def cli(outfile, envpath, multifile, defaultparams, tfvars, workflow, pipepath):
    ...
    See https://github.com/ThoughtWorks-DPS/circlecigen for detailed usage instructions.
    ...
    generate_config(pipepath, outfile, envpath, read_json_file(envpath, multifile), workflow)
